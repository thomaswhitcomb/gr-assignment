...
(require '[gr.handlers.command :as h])
(require '[gr.handlers.util :as u])
...
(deftest test-view-to-column-numbers
  (is (= (u/view-to-column-numbers "1") [3 0]))
  (is (= (u/view-to-column-numbers "2") [4]))
  (is (= (u/view-to-column-numbers "3") [0])))

(deftest test-view-to-comparer
  (is (= ((u/view-to-comparer "1") 1 1) 0)))

(deftest test-date-transformer
  (is (= (u/date-transformer "06/10/1958") 19581006)))
